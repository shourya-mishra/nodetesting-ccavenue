  ...
  componentDidMount(){
    ...
    var origproducts = []
      ...
      try {
        ...
        var cat = decodeURI(data.cat)
        var sub = decodeURI(data.sub)
        ...
        this.gotoproductview = async (item) => {
          console.log(item)
          globalthis.props.history.push('/shopnow/'+item.ProductNameURL+'/'+item.ProductID+'')
                ...
                <div key={i} className="productsCard_container">
                          ...
                          <div className="productsCard_contentContainer product_col">             
                            ...
                            <div className="products_row1">
                              <Rating size={16} className="productstars"  readonly initialValue={4} ratingValue={item.Ratings} />
                              <div className="productsCard_btn" onClick={() => this.gotoproductview2(item)}>Shop Now</div>
                            </div>
                          </div>
                        </div>
                    </>
