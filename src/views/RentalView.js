...
class RentalView extends React.Component {
  ...
  componentDidMount(){
    ...
    this.initialfetch = async () => {
      ...
      axios
        .post('https://admin.rehamo.com/api/getrentalproductdataurl', {
          ProductID: id,
        })
        .then(function (response) {
          ...
          if (response.data.Status === 'product found') {
            ...
            globalthis.setState ({ rentaldeposit: Product.RentalDeposit});
            globalthis.setState ({ rentalgst: Product.RentalGST});
            globalthis.setState ({ rentalprice: Product.RentalPrice});
      ...
      if (item.ProductStatus =="Active") {
        if(item.ProductID !== productid){
            ...
            <div key={i} className="productView_wrapper">
              ...
              <img className="productView_img" onClick={() => this.gotoproductview(item)} src={Image_Http_URL} alt="Image"/>
              <img className="compo12card_like" src={require("../assets/img/compo12/like.png")} alt="Image"/>
                  ...
                  <div className="productView_contentContainer">             
                    <p className="productView_text" onClick={()=>this.gotorentalview2(item)}>{item.ProductName}</p>
                    {/*<ReactStars
                        count={5}
                        size={20}
                        isHalf={true}
                    ...
                    />*/}
                      ...
                      <button className="pvshopnowbtn2" onClick={()=>this.gotorentalview2(item)}>Shop Now</button>
                    </div>       
                  </div>
              </div>
...
{this.state.ratingfetched?(
  ...
  <div className="ratesRow2">
  <h3 className="productInfo">Refundable Deposit  :  ₹ {this.state.rentaldeposit}</h3>
  <h3 className="productInfo">GST(18%)  :  ₹ {this.state.rentalgst}</h3>
  <h3 className="productInfo">Total Price  :  ₹ {this.state.rentalprice}/month</h3>
  <h3 className="productInfo">Rental Only in Bangalore*</h3>
</div>
