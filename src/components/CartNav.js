                ...
                <div className="overflowcart">
                    {
                        cart.map(item =>{
                            ...
                            return(
                            <div lg="12" className="cartproduct" key={item.uid}>
                                    <div lg="5"  className="mobilefive">
                                    <img onClick={()=> {window.location.href = '/shopnow/'+item.data.ProductName+'/'+item.data.ProductID+''}}
                                    className="cartproductimg" src={img} alt=""/>
                                    </div>
                                    <div lg="7"  className="mobileseven">
                                    <div className="cartproductdiv">
                                            <div className="cartproductrow">
                                                ...
                                                {item.psize.size!==''?(<h6 className="cartsize">{item.psize.size}</h6>):(<h6 className="cartsize">General</h6>)}
                                                {item.psize.color!==''?(
                                                <h6 className="cartcolor">Color: <div className='cartcolorinside' style={{backgroundColor:item.pcolor.color}}></div></h6>
                                                ):(
                                                    <h6 className="cartcolor">Color: <div className='cartcolorinside' style={{backgroundColor:'#000000'}}></div></h6>
                                                    )}
                                        ...
                                        <div className="cartproductdelete" onClick={() => removeProduct(item.uid)}>X</div>
                                    </div>
                    ...
                    <Col lg="12" className="carttotaldiv">
                        ...
                        <button id="cartcheckout" className="cartcheckout" >Checkout</button>
                    </Col>
                </>
                )
            }
